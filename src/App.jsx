...
function App() {
  ...
  const projects = [
    {
      ...
      description:
        "A custom WooCommerce plugin developed from scratch that enables customers to add color attributes to their cart as free samples, enhancing the shopping experience for products requiring color selection.",
    ...
    },
    {
      ...
      description:
        "Custom Shopify theme development with specialized sections designed to optimize conversion rates for this premium fashion e-commerce platform, featuring enhanced user experience and performance.",
      image: basementImage,
      technologies: [
    ...
    },
    {
      ...
      description:
        "Complete WordPress e-commerce solution featuring a custom PUDO shipping plugin that integrates with PUDO API and automates shipping processes through ShipStation integration.",
    ...
    },
    {
      ...
      description:
        "Modern website design and development using WordPress and Elementor Pro, creating an intuitive and visually appealing digital presence with custom layouts and responsive design.",
    ...
    },
    {
      ...
      description:
        "Full-stack web application built with modern technologies including React, Next.js, MongoDB, and Node.js, featuring interactive paddle quiz functionality and dynamic user experiences.",
    ...
    },
    {
      ...
      description:
        "Professional corporate website developed using HTML5, CSS3, and Bootstrap framework, delivering a clean and responsive design optimized for financial services presentation.",
    ...
    },
    {
      ...
      description:
        "Custom Shopify theme designed and developed from scratch for the pickleball sports equipment market, featuring specialized product showcases and optimized checkout processes.",
  ...
  useEffect(() => {
    const sections = document.querySelectorAll(
      ".hero-section, .projects-section, .services-section, .experience-section, .contact-section"
    );
      ...
      <section className="hero-section">
        ...
        >
          ...
          <div className="left-column">
            ...
            >
              ...
              <p className="profile-description">
                Hi, I'm abrarul hoque. I design conversion-first websites that
          ...
          <div className="right-column">
            <motion.div className="project-fit-card" variants={cardVariants}>
                  ...
                  <div className="fit-chips">
                    {projectFitOptions.platform.map((option) => (
                      <motion.button
                        key={option}
                        className={`fit-chip ${
                          projectFit.platform === option ? "active" : ""
                        }`}
                        onClick={() =>
                          handleProjectFitChange("platform", option)
                        }
                  ...
                  <div className="fit-chips">
                    {projectFitOptions.budget.map((option) => (
                      <motion.button
                        key={option}
                        className={`fit-chip ${
                          projectFit.budget === option ? "active" : ""
                        }`}
                  ...
                  <div className="fit-chips">
                    {projectFitOptions.timeline.map((option) => (
                      <motion.button
                        key={option}
                        className={`fit-chip ${
                          projectFit.timeline === option ? "active" : ""
                        }`}
                        onClick={() =>
                          handleProjectFitChange("timeline", option)
                        }
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
          ...
          >
            <div className="experience-card">
              ...
              <div className="experience-details">
                ...
                <p className="experience-description">
                  Successfully delivered 100+ WordPress and Shopify projects as
                  a freelance developer, specializing in custom theme
                  development, e-commerce solutions, and performance
                  optimization for clients worldwide.
                </p>
              </div>
            </div>
            ...
            <div className="experience-card">
              ...
              <div className="experience-details">
                ...
                <p className="experience-description">
                  Developed multiple custom WordPress plugins from scratch,
                  focusing on WooCommerce integrations, API implementations, and
                  complex functionality enhancements that improved user
            ...
            <div className="experience-card">
              ...
              <div className="experience-details">
                ...
                <p className="experience-description">
                  Built and maintained responsive WordPress websites with focus
                  on performance optimization, SEO implementation, and
                  user-friendly content management systems for service-based
                  business operations.
                </p>
              </div>
            </div>
            ...
            <div className="experience-card">
              ...
              <div className="experience-details">
                ...
                <p className="experience-description">
                  Created custom Shopify themes and e-commerce solutions,
                  implementing conversion-focused designs, payment integrations,
                  and enhanced shopping experiences that drove sales growth for
